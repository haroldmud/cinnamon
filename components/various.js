      ...
      <section className="main flex md:flex-row flex-col py-44 mb-32">
        ...
        <div className="md:ml-32 mt-20 ml-4">
          <div className="flex border-b border-gray-500 w-fit pb-8">
            <p className="text-white text-2xl font-bold">Android Developer</p>
          ...
          <div className="flex w-fit py-4">
            <p className="text-white text-2xl font-bold md:w-5/6 w-3/5">Backend Developer team Lead</p>
            <div>
            ...
            <p className="text-transparent  border-t border-gray-500  md:w-24/4r w-19/4r">Now some young niggas like to swang</p>
        </div>
      </section>
